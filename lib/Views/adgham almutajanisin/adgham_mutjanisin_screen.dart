...
class AdghamalmutajanisinPage extends StatelessWidget {
  const AdghamalmutajanisinPage({super.key});
        ...
        children: [
          ...
          const Expanded(
            child: CustomAudiosFiles(
              firstbucket: 'adgham almutajanisin',
              secondbucket: 'adgham almutajanisin',
            ),
          ),
        ],
      ),
