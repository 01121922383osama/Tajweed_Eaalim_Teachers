...
class AlEkhfaaAlshafwyPage extends StatelessWidget {
  const AlEkhfaaAlshafwyPage({super.key});

  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('AlekhafaaAlshafway'),
      ),
      body: Column(
        children: [
          SizedBox(
          ...
          const Expanded(
            child: CustomAudiosFiles(
              firstbucket: 'AlmimAlsaakinah',
              secondbucket: 'AlekhafaaAlshafway',
            ),
          ),
        ],
      ),
