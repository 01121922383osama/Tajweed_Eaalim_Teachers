...
class AlqalqaluhAlkubraaPage extends StatelessWidget {
  const AlqalqaluhAlkubraaPage({super.key});
        ...
        children: [
          ...
          const Expanded(
            child: CustomAudiosFiles(
              firstbucket: 'AlqalqaluhAlkubraa',
              secondbucket: 'AlqalqaluhAlkubraa',
            ),
          ),
        ],
      ),
