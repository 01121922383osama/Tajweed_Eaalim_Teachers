...
class QalqalaSoghraPage extends StatelessWidget {
  const QalqalaSoghraPage({super.key});

  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('القلقله الصغري'),
      ),
      body: Column(
        children: [
          SizedBox(
          ...
          const Expanded(
            child: CustomAudiosFiles(
              firstbucket: 'QalqalaSoghra',
              secondbucket: 'QalqalaSoghra',
            ),
          ),
        ],
      ),
