...
class AlmadAlsilahAlkubraaPage extends StatelessWidget {
  const AlmadAlsilahAlkubraaPage({super.key});

  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('AlmadAlsilahAlkubraa'),
      ),
      body: Column(
        children: [
          SizedBox(
          ...
          const Expanded(
            child: CustomAudiosFiles(
              firstbucket: 'AlmadAlsilahAlkubraa',
              secondbucket: 'AlmadAlsilahAlkubraa',
            ),
          ),
        ],
      ),
