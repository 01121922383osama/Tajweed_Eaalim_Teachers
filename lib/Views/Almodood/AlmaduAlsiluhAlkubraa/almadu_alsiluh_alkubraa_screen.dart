...
class AlmaduAlsiluhAlkubraaPage extends StatelessWidget {
  const AlmaduAlsiluhAlkubraaPage({super.key});

  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('AlmaduAlsiluhAlkubraa'),
      ),
      body: Column(
        children: [
          SizedBox(
          ...
          const Expanded(
            child: CustomAudiosFiles(
              ...
              secondbucket: 'AlmaduAlsiluhAlkubraa',
            ),
          ),
        ],
      ),
