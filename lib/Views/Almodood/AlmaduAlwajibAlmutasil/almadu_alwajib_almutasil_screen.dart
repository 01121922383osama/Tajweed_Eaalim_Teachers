...
class AlmaduAlwajibAlmutasilPage extends StatelessWidget {
  const AlmaduAlwajibAlmutasilPage({super.key});

  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('AlmaduAlwajibAlmutasil'),
      ),
      body: Column(
        children: [
          SizedBox(
          ...
          const Expanded(
            child: CustomAudiosFiles(
              ...
              secondbucket: 'AlmaduAlwajibAlmutasil',
            ),
          ),
        ],
      ),
