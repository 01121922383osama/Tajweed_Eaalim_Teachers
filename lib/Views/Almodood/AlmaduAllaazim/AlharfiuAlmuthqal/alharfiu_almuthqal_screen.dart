...
class AlharfiuAlmuthqalPage extends StatelessWidget {
  const AlharfiuAlmuthqalPage({super.key});

  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('AlharfiuAlmuthqal'),
      ),
      body: Column(
        children: [
          SizedBox(
          ...
          const Expanded(
            child: CustomAudiosFiles(
              ...
              secondbucket: 'AlmaduAllaazim/AlharfiuAlmuthqal',
            ),
          ),
        ],
      ),
