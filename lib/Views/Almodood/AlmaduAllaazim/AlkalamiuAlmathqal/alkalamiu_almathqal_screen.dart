...
class AlkalamiuAlmathqalPage extends StatelessWidget {
  const AlkalamiuAlmathqalPage({super.key});

  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('AlkalamiuAlmathqal'),
      ),
      body: Column(
        children: [
          SizedBox(
          ...
          const Expanded(
            child: CustomAudiosFiles(
              ...
              secondbucket: 'AlmaduAllaazim/AlkalamiuAlmathqal',
            ),
          ),
        ],
      ),
