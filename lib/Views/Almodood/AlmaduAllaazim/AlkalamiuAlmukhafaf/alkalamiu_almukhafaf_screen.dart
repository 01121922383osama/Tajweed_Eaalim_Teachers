...
class AlkalamiuAlmukhafafPage extends StatelessWidget {
  const AlkalamiuAlmukhafafPage({super.key});

  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('AlkalamiuAlmukhafaf'),
      ),
      body: Column(
        children: [
          SizedBox(
          ...
          const Expanded(
            child: CustomAudiosFiles(
              ...
              secondbucket: 'AlmaduAllaazim/AlkalamiuAlmukhafaf',
            ),
          ),
        ],
      ),
