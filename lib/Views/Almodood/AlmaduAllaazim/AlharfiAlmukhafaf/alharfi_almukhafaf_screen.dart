...
class AlharfiAlmukhafafPage extends StatelessWidget {
  const AlharfiAlmukhafafPage({super.key});

  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('AlharfiAlmukhafaf'),
      ),
      body: Column(
        children: [
          SizedBox(
          ...
          const Expanded(
            child: CustomAudiosFiles(
              ...
              secondbucket: 'AlmaduAllaazim/AlharfiAlmukhafaf',
            ),
          ),
        ],
      ),
