...
class AlmaduAljayizAlmunfasilPage extends StatelessWidget {
  const AlmaduAljayizAlmunfasilPage({super.key});

  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('AlmaduAljayizAlmunfasil'),
      ),
      body: Column(
        children: [
          SizedBox(
          ...
          const Expanded(
            child: CustomAudiosFiles(
              firstbucket: 'AlmaduAljayizAlmunfasil',
              secondbucket: 'AlmaduAljayizAlmunfasil',
            ),
          ),
        ],
      ),
