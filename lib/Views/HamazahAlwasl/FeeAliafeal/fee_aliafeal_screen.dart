...
class FeeAliafealPage extends StatelessWidget {
  const FeeAliafealPage({super.key});

  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('FaaAliafeal'),
      ),
      body: Column(
        children: [
          SizedBox(
          ...
          const Expanded(
            child: CustomAudiosFiles(
              firstbucket: 'HamazahAlwasl',
              secondbucket: 'FaaAliafeal',
            ),
          ),
        ],
      ),
