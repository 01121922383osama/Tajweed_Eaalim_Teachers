...
class ALidghamBilaghunaPage extends StatelessWidget {
  const ALidghamBilaghunaPage({super.key});

  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('ALidghamBilaghuna'),
      ),
      body: Column(
        children: [
          SizedBox(
          ...
          const Expanded(
            child: CustomAudiosFiles(
              firstbucket: 'AlnuwnAlsaakinatWaltanwin',
              secondbucket: 'ALidgham/ALidghamBilaghuna',
            ),
          ),
        ],
      ),
