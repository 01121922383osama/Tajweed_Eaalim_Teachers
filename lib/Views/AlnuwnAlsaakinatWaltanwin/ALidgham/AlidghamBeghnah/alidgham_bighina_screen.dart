...
class ALidghamBighinaPage extends StatelessWidget {
  const ALidghamBighinaPage({super.key});

  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('ALidghamBighina'),
      ),
      body: Column(
        children: [
          SizedBox(
          ...
          const Expanded(
            child: CustomAudiosFiles(
              ...
              secondbucket: 'ALidgham/ALidghamBighina',
            ),
          ),
        ],
      ),
