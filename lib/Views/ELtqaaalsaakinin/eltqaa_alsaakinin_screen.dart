...
class ELtqaaalsaakininPage extends StatelessWidget {
  const ELtqaaalsaakininPage({super.key});

  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('ELtqaaalsaakinin'),
      ),
      body: Column(
        children: [
          SizedBox(
          ...
          const Expanded(
            child: CustomAudiosFiles(
              firstbucket: 'ELtqaaalsaakinin',
              secondbucket: 'ELtqaaalsaakinin',
            ),
          ),
        ],
      ),
