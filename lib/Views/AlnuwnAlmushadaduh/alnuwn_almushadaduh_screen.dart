...
class AlnuwnAlmushadaduhPage extends StatelessWidget {
  const AlnuwnAlmushadaduhPage({super.key});

  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('AlnuwnAlmushadaduh'),
      ),
      body: Column(
        children: [
          SizedBox(
          ...
          const Expanded(
            child: CustomAudiosFiles(
              firstbucket: 'AlnuwnAlmushadaduh',
              secondbucket: 'AlnuwnAlmushadaduh',
            ),
          ),
        ],
      ),
