...
class AlmimAlmushadaduhPage extends StatelessWidget {
  const AlmimAlmushadaduhPage({super.key});

  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('AlmimAlmushadaduh'),
      ),
      body: Column(
        children: [
          SizedBox(
          ...
          const Expanded(
            child: CustomAudiosFiles(
              firstbucket: 'AlmimAlmushadaduh',
              secondbucket: 'AlmimAlmushadaduh',
            ),
          ),
        ],
      ),
