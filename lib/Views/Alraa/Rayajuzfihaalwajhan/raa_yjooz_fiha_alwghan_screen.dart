...
class RayajuzfihaalwajhanPage extends StatelessWidget {
  const RayajuzfihaalwajhanPage({super.key});

  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('راء يجوز فيها الوجهان'),
      ),
      body: Column(
        children: [
          SizedBox(
          ...
          const Expanded(
            child: CustomAudiosFiles(
              firstbucket: 'Alraa',
              secondbucket: 'Rayajuzfihaalwajhan',
            ),
          ),
        ],
      ),
